<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginFunc.aspx.cs" Inherits="Default36" %>
    ...
    &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
            ...
            ErrorMessage="*" ControlToValidate="txtSenha"></asp:RequiredFieldValidator>
                ...
                <center>
                    ...
                    <asp:CheckBox ID="chkManterLogado" runat="server" style="font-size: xx-small" 
     ...
     <p>
          <asp:SqlDataSource ID="sqlLogin" runat="server" 
            ...
            ProviderName="<%$ ConnectionStrings:monarcaConnectionString.ProviderName %>" 
              ...
              SelectCommand="SELECT login_func, senha_func, id_func, status FROM funcionario WHERE (login_func = @usuario) AND (senha_func = @senha) AND (status = '0')">
            <SelectParameters>
         ...
         <asp:SqlDataSource ID="sqlManterLogado" runat="server" 
             ConnectionString="<%$ ConnectionStrings:monarcaConnectionString %>" 
             ProviderName="<%$ ConnectionStrings:monarcaConnectionString.ProviderName %>" 
             SelectCommand="SELECT * FROM loginrecentefunc"></asp:SqlDataSource>

         <asp:SqlDataSource ID="sqlAtualizarRecente" runat="server" 
             ConnectionString="<%$ ConnectionStrings:monarcaConnectionString %>" 
             ProviderName="<%$ ConnectionStrings:monarcaConnectionString.ProviderName %>" 
             SelectCommand="SELECT * FROM [loginrecentefunc]" 
             UpdateCommand="UPDATE loginrecentefunc SET login_rec_func = @login">
             <UpdateParameters>
         ...
         <asp:SqlDataSource ID="sqlApagarRecente" runat="server" 
             ConnectionString="<%$ ConnectionStrings:monarcaConnectionString %>" 
             DeleteCommand="DELETE FROM loginrecentefunc" 
             ProviderName="<%$ ConnectionStrings:monarcaConnectionString.ProviderName %>" 
             SelectCommand="SELECT * FROM [loginrecentefunc]"></asp:SqlDataSource>

         <asp:SqlDataSource ID="sqlSalvarRecente" runat="server" 
             ConnectionString="<%$ ConnectionStrings:monarcaConnectionString %>" 
             InsertCommand="INSERT INTO loginrecentefunc(login_rec_func) VALUES (@login)" 
             ProviderName="<%$ ConnectionStrings:monarcaConnectionString.ProviderName %>" 
             SelectCommand="SELECT * FROM [loginrecentefunc]">
             <InsertParameters>
                 <asp:ControlParameter ControlID="txtLogin" Name="login" PropertyName="Text" />
        ...
        <p>
            <asp:SqlDataSource ID="sqlDataFunc" runat="server" 
                ConnectionString="<%$ ConnectionStrings:monarcaConnectionString %>" 
                ProviderName="<%$ ConnectionStrings:monarcaConnectionString.ProviderName %>" 
                SelectCommand="SELECT id_func, login_func, senha_func, email_func, perg_func, resp_func, data_conta FROM funcionario WHERE (id_func = @idFunc)">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="sqlResetarSenha" runat="server" 
                ...
                UpdateCommand="UPDATE funcionario SET id_func =, data_conta = @data_alt, senha_func = @senha WHERE (id_func = @codFUNC)">
                <UpdateParameters>
            ...
            <asp:SqlDataSource ID="sqlRegistro" runat="server" 
                ConnectionString="<%$ ConnectionStrings:monarcaConnectionString %>" 
                InsertCommand="INSERT INTO registrologin(id_adm, id_func, data_registro, registro) VALUES (NULL, @func, @data, @registro)" 
                ProviderName="<%$ ConnectionStrings:monarcaConnectionString.ProviderName %>" 
