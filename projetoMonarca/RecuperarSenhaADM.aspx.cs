...
public partial class RecuperarSenhaADM : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sqlResetarSenhaADM.UpdateParameters["data_alt"].DefaultValue = dataSenha;
        sqlResetarSenhaADM.UpdateParameters["senha"].DefaultValue = newPass.ToString();
        sqlResetarSenhaADM.Update();

        Session["novaSenhaADMSenha"] = newPass.ToString();
        ...
        MailAddress destinatario = new MailAddress(Session["emailADMSenha"].ToString(), "Administrador");
        MailMessage mensagem = new MailMessage(remetente, destinatario);

        mensagem.Body = "Olá!"
                        + "\r\n" + ""
                        + "Sua senha foi alterada, conforme pedido enviado para nosso site. Agora, sua senha é <b>" + Session["novaSenhaADMSenha"].ToString() + "</b>."
