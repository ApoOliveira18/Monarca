<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageFunc.master" AutoEventWireup="true" CodeFile="PesquisaPerfumeFunc.aspx.cs" Inherits="PesquisaPerfume" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    
    <h1 class="posicionamento">Pesquisa Perfumes</h1>
...
&nbsp;<asp:Button ID="btnPesquisar" runat="server" Text="Pesquisar" 
    ...
    <asp:SqlDataSource ID="sqlBuscarDescontoDoProduto" runat="server" 
        ...
        <SelectParameters>
            <asp:SessionParameter Name="produto" SessionField="produto" />
        </SelectParameters>
    </asp:SqlDataSource>
