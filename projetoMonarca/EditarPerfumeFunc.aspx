<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageFunc.master" AutoEventWireup="true" CodeFile="EditarPerfumeFunc.aspx.cs" Inherits="EditarPerfume" %>
 ...
 <br />
    ...
    &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ...
        <p>
            ----------------------------------------------------</p>
        <p>
            Só aceita uma ÚNICA Promoção!!</p>
        <p>
...
&nbsp;
        ...
        <p>
            <strong>Opção 2.</strong> Linha:&nbsp;<asp:DropDownList ID="ddlLinha" 
            runat="server" 
