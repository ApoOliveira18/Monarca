<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageFunc.master" AutoEventWireup="true" CodeFile="PesquisaVendasFunc.aspx.cs" Inherits="PesquisaVendas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1 class="posicionamento">Pesquisa Vendas</h1>
...
&nbsp;<asp:Button ID="btnPesquisar" runat="server" Text="Pesquisar" 
    ...
    <p>
        <asp:GridView ID="gvExibir" runat="server" BackColor="White" 
            ...
            DataKeyNames="id_venda" style="text-align: center">
            <Columns>
