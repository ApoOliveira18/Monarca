...
public partial class teste_cliente : System.Web.UI.Page
{
    ...
    public void clickEntrar() {
        ...
        if (dv.Table.Rows.Count == 0)
        {
            ...
            if (qtdErros >= 3)
            {
                ...
                lblCaptcha.Text = "Por favor, para a sua segurança, digite o texto abaixo:";
    ...
    {
        Session["NomeCli"] = txtNomeCli.Text;
        Session["EmailCli"] = txtEmailCli.Text;
