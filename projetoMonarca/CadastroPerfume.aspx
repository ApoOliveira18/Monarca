<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageADM.master" AutoEventWireup="true" CodeFile="CadastroPerfume.aspx.cs" Inherits="CadastroPerfume" %>
...
<h1 class="posicionamento">Cadastro de Perfumes</h1>
...
<div class="caixa_tudo">
 ...
 <p>Nome do Produto: 
    ...
    <p> <strong>Só aceita uma ÚNICA Promoção!!</strong></p>
...
&nbsp;<asp:SqlDataSource ID="sqlLinha" runat="server" 
        ...
        <asp:SqlDataSource ID="sqlLinhaSession" runat="server" 
            ConnectionString="<%$ ConnectionStrings:monarcaConnectionString %>" 
            ProviderName="<%$ ConnectionStrings:monarcaConnectionString.ProviderName %>" 
            SelectCommand="SELECT linha.id_linha, linha.id_promo, linha.tipo_linha, promocao.desconto, promocao.titulo_promo FROM linha INNER JOIN promocao ON linha.id_promo = promocao.id_promo WHERE (linha.id_linha = @linha)">
            <SelectParameters>
                <asp:SessionParameter Name="linha" SessionField="idLinha" />
            </SelectParameters>
        </asp:SqlDataSource>
...
&nbsp;<asp:SqlDataSource ID="sqlPromo" runat="server" 
 ...
 <p>&nbsp;<label class="file-upload"><strong>Foto</strong>
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
    ...
    <p>
        <asp:SqlDataSource ID="sqlPerfume" runat="server" 
            ConnectionString="<%$ ConnectionStrings:monarcaConnectionString %>" 
            InsertCommand="INSERT INTO produto(id_genero, id_linha, id_ml, nome_prod, desc_prod, slogan_prod, valorUnid_prod, img_prod, qtd_disponivel, valor_prod_final, valor_acrescimo, id_promo, status, id_android) VALUES (@genero, @linha, @ml, @nome, @desc , @slogan, @precoUnid, @foto, @qtd, @precoFinal, @precoAcres, @promo, '0', 1)" 
            ProviderName="<%$ ConnectionStrings:monarcaConnectionString.ProviderName %>" 
...
<asp:Parameter Name="slogan"></asp:Parameter>
                ...
                <asp:SessionParameter Name="promoLinha" SessionField="promoLinha" />
                <asp:SessionParameter Name="promoGenero" SessionField="promoGenero" />
            </InsertParameters>
        </asp:SqlDataSource>
