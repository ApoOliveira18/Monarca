...
public partial class EditarCliente : System.Web.UI.Page
{
    ...
    protected void btnEditar_Click(object sender, EventArgs e)
    {
        ...
        if (dt < dtNascimentoMax)
        {
            ...
            sqlRegistro.InsertParameters["registro"].DefaultValue = cripto.Encrypt("Edição Cliente");
            ...
            sqlRegistro.InsertParameters["cliente"].DefaultValue = cripto.Encrypt(txtNome.Text);
