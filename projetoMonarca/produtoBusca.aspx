<%@ Page Title="" Language="C#" MasterPageFile="~/MasterGeral.master" AutoEventWireup="true" CodeFile="produtoBusca.aspx.cs" Inherits="produto" %>
        ...
        <asp:Label ID="lblDescComplemento" runat="server"></asp:Label>
         ...
         <div class="preco-perf ">
            ...
            <asp:SqlDataSource ID="sqlPesquisaPreco" runat="server" 
                ...
                <SelectParameters>
                    <asp:QueryStringParameter DefaultValue="" Name="cod" QueryStringField="id" />
                </SelectParameters>
            </asp:SqlDataSource>
             ...
             <asp:Label ID="lblPrecoAntigo" runat="server" Font-Size="20pt" 
                 Font-Strikeout="True" Visible="False"></asp:Label>
            <br />
